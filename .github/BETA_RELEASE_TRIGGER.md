...
Current requested beta: `0.3.13` (`versionCode 16`) — visible local history, per-contact
two-message protection proposal, optional emergency onboarding and Google Play hand-off candidate.
